package net.remmintan.mods.minefortress.utils;
...
public class PathUtils {
    ...
    public static Iterable<BlockPos> fromStartToEnd(BlockPos start, BlockPos end, boolean skipEverySecond) {
