...
public class FortressChannelNames {
    ...
    public static final String FORTRESS_FOLLOW_COLONIST = "fortress_follow_colonist";
    ...
    public static final String FORTRESS_INVALIDATE_BLUEPRINT = "fortress_invalidate_blueprint";
