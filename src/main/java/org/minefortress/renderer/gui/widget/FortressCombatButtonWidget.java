...
public class FortressCombatButtonWidget extends FortressItemButtonWidget {

    public FortressCombatButtonWidget(int x, int y, Item item, ItemRenderer itemRenderer, PressAction clickAction, TooltipSupplier tooltipSupplier, Text text) {
    ...
    protected void renderItem(MatrixStack matrices) {
        ...
        if(fortressClient.getFortressClientManager().isInCombat()) {
