...
public class FortressRoadsButtonWidget extends FortressItemButtonWidget {
    ...
    public FortressRoadsButtonWidget(int x, int y, Item item, ItemRenderer itemRenderer, PressAction clickAction, TooltipSupplier tooltipSupplier, Text text) {
    ...
    protected void renderItem(MatrixStack matrices) {
        ...
        if(fortressClient.getSelectionManager().getSelectionTypeIndex() == org.minefortress.selections.SelectionType.ROADS.ordinal()) {
